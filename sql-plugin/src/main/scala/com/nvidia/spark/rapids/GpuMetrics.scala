...
object GpuMetric extends Logging {
  ...
  val SCAN_READ_WINDOW_INITIAL = "scanReadWindowInitial"
  val SCAN_READ_WINDOW_CURRENT = "scanReadWindowCurrent"
  val SCAN_READ_WINDOW_MAX = "scanReadWindowMax"
  val SCAN_READ_IN_FLIGHT_MAX = "scanReadInFlightMax"
  val SCAN_READ_READY_MAX = "scanReadReadyMax"
  val SCAN_READ_BACKLOG_MAX = "scanReadBacklogMax"
  val SCAN_READ_WINDOW_INCREASES = "scanReadWindowIncreases"
  val SCAN_READ_WINDOW_DECREASES = "scanReadWindowDecreases"
  val SCAN_READ_WINDOW_MEMORY_DECREASES = "scanReadWindowMemoryDecreases"
  val SCAN_READ_WINDOW_SCHEDULE_DECREASES = "scanReadWindowScheduleDecreases"
  ...
  val DESCRIPTION_SCAN_READ_WINDOW_INITIAL = "scan read window initial"
  val DESCRIPTION_SCAN_READ_WINDOW_CURRENT = "scan read window current"
  val DESCRIPTION_SCAN_READ_WINDOW_MAX = "scan read window max"
  val DESCRIPTION_SCAN_READ_IN_FLIGHT_MAX = "scan read in-flight max"
  val DESCRIPTION_SCAN_READ_READY_MAX = "scan read ready max"
  val DESCRIPTION_SCAN_READ_BACKLOG_MAX = "scan read backlog max"
  val DESCRIPTION_SCAN_READ_WINDOW_INCREASES = "scan read window increases"
  val DESCRIPTION_SCAN_READ_WINDOW_DECREASES = "scan read window decreases"
  val DESCRIPTION_SCAN_READ_WINDOW_MEMORY_DECREASES =
    "scan read window memory decreases"
  val DESCRIPTION_SCAN_READ_WINDOW_SCHEDULE_DECREASES =
    "scan read window schedule decreases"
